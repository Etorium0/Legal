...
const AvatarView: React.FC<AvatarViewProps> = ({ 
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center bg-darker rounded-2xl overflow-hidden border border-gray-800 shadow-2xl relative">
      ...
      {/* CSS for animations if not in tailwind config */}
      <style>{`
        @keyframes blob {
